...
class PrivateMessagesController extends AppController {
	...
	public function browse() {
		...
		$messages_out_count = $this->PrivateMessage->UserPrivateMessage->find('count', array(
					'conditions' => array(
		...
		$messages_myNotes_count = $this->PrivateMessage->UserPrivateMessage->find('count', array(
					'conditions' => array(
						'PrivateMessage.sender_id' => $this->userId,
						'PrivateMessage.deleted' => false,
						'Receiver.id' => $this->userId
	...
	function count($page) {
		$id = $this->userId;
		$count = $this->PrivateMessage->UserPrivateMessage->find('count', array(
					'conditions' => array(
						'receiver_id' => $this->userId,
						'UserPrivateMessage.deleted' => false,
